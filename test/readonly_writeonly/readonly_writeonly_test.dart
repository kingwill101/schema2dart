...
void main() {
  group('readOnly and writeOnly support', () {
    ...
    setUp(() {
      final schemaJson = File('test/readonly_writeonly/user_schema.json').readAsStringSync();
    ...
    test('should add comments for readOnly properties', () {
      ...
      expect(result, contains('/// Unique user identifier generated by the server'));
      expect(result, contains('/// READ-ONLY: This property is managed by the server'));
    ...
    test('should add comments for writeOnly properties', () {
      ...
      expect(result, contains('/// User password - never returned in responses'));
      expect(result, contains('/// WRITE-ONLY: This property should not be included in responses'));
    });
    ...
    test('should still include readOnly/writeOnly fields in serialization', () {
      ...
      expect(result, contains("if (password != null) map['password'] = password;"));
    });
    ...
    test('generated code should compile', () {
      ...
      expect(analyzeResult.exitCode, 0,
          reason: 'Generated code should pass dart analyze:\n${analyzeResult.stdout}\n${analyzeResult.stderr}');
    });
  });
}
