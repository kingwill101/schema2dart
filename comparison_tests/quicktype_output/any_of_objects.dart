...
AnyOfObjects anyOfObjectsFromJson(String str) =>
    AnyOfObjects.fromJson(json.decode(str));
...
class AnyOfObjectsProperties {
  ...
  AnyOfObjectsProperties({required this.data});

  factory AnyOfObjectsProperties.fromJson(Map<String, dynamic> json) =>
      AnyOfObjectsProperties(data: Data.fromJson(json["data"]));
