...
AllOfComposition allOfCompositionFromJson(String str) => AllOfComposition.fromJson(json.decode(str));

String allOfCompositionToJson(AllOfComposition data) => json.encode(data.toJson());
...
class AllOfComposition {
    ...
    factory AllOfComposition.fromJson(Map<String, dynamic> json) => AllOfComposition(
        schema: json["\u0024schema"],
        type: json["type"],
