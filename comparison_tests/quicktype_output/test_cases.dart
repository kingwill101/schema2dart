...
class TestCase {
  ...
  TestCase({required this.name, required this.schema});

  factory TestCase.fromJson(Map<String, dynamic> json) =>
      TestCase(name: json["name"], schema: Schema.fromJson(json["schema"]));

  Map<String, dynamic> toJson() => {"name": name, "schema": schema.toJson()};
}
...
class Schema {
  ...
  factory Schema.fromJson(Map<String, dynamic> json) => Schema(
    ...
    properties: json["properties"] == null
        ? null
        : SchemaProperties.fromJson(json["properties"]),
    allOf: json["allOf"] == null
        ? []
        : List<AllOf>.from(json["allOf"]!.map((x) => AllOf.fromJson(x))),
    additionalProperties: json["additionalProperties"] == null
        ? null
        : AdditionalProperties.fromJson(json["additionalProperties"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "allOf": allOf == null
        ? []
        : List<dynamic>.from(allOf!.map((x) => x.toJson())),
...
class AdditionalProperties {
  ...
  AdditionalProperties({required this.type});

  factory AdditionalProperties.fromJson(Map<String, dynamic> json) =>
      AdditionalProperties(type: json["type"]);
...
class AllOfProperties {
  ...
  AllOfProperties({this.name, this.age});

  factory AllOfProperties.fromJson(Map<String, dynamic> json) =>
      AllOfProperties(
        name: json["name"] == null
            ? null
            : AdditionalProperties.fromJson(json["name"]),
        age: json["age"] == null
            ? null
            : AdditionalProperties.fromJson(json["age"]),
      );
...
class SchemaProperties {
  ...
  factory SchemaProperties.fromJson(Map<String, dynamic> json) =>
      SchemaProperties(
        user: json["user"] == null ? null : User.fromJson(json["user"]),
        users: json["users"] == null ? null : Users.fromJson(json["users"]),
        value: json["value"] == null ? null : Value.fromJson(json["value"]),
        data: json["data"] == null ? null : Data.fromJson(json["data"]),
        known: json["known"] == null
            ? null
            : AdditionalProperties.fromJson(json["known"]),
...
class AnyOf {
  ...
  AnyOf({required this.type, required this.properties, required this.required});
...
class AnyOfProperties {
  ...
  AnyOfProperties({required this.type, this.content, this.value});

  factory AnyOfProperties.fromJson(Map<String, dynamic> json) =>
      AnyOfProperties(
        type: Type.fromJson(json["type"]),
        content: json["content"] == null
            ? null
            : AdditionalProperties.fromJson(json["content"]),
        value: json["value"] == null
            ? null
            : AdditionalProperties.fromJson(json["value"]),
      );
...
class Type {
  ...
  Type({required this.typeConst});

  factory Type.fromJson(Map<String, dynamic> json) =>
      Type(typeConst: json["const"]);

  Map<String, dynamic> toJson() => {"const": typeConst};
}
...
class Value {
  ...
  factory Value.fromJson(Map<String, dynamic> json) => Value(
    oneOf: List<AdditionalProperties>.from(
      json["oneOf"].map((x) => AdditionalProperties.fromJson(x)),
    ),
  );
