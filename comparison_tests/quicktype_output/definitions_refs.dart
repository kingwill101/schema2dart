...
DefinitionsRefs definitionsRefsFromJson(String str) => DefinitionsRefs.fromJson(json.decode(str));

String definitionsRefsToJson(DefinitionsRefs data) => json.encode(data.toJson());
...
class DefinitionsRefs {
    ...
    factory DefinitionsRefs.fromJson(Map<String, dynamic> json) => DefinitionsRefs(
        schema: json["\u0024schema"],
...
class DefinitionsRefsProperties {
    ...
    factory DefinitionsRefsProperties.fromJson(Map<String, dynamic> json) => DefinitionsRefsProperties(
