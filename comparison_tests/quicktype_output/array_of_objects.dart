...
ArrayOfObjects arrayOfObjectsFromJson(String str) => ArrayOfObjects.fromJson(json.decode(str));
...
class ArrayOfObjectsProperties {
    ...
    ArrayOfObjectsProperties({
        required this.users,
    });

    factory ArrayOfObjectsProperties.fromJson(Map<String, dynamic> json) => ArrayOfObjectsProperties(
