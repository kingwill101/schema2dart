...
QuicktypePubspec quicktypePubspecFromJson(String str) => QuicktypePubspec.fromJson(json.decode(str));

String quicktypePubspecToJson(QuicktypePubspec data) => json.encode(data.toJson());
...
class QuicktypePubspec {
    ...
    factory QuicktypePubspec.fromJson(Map<String, dynamic> json) => QuicktypePubspec(
        schema: json["\u0024schema"],
        title: json["title"],
...
class QuicktypePubspecProperties {
    ...
    factory QuicktypePubspecProperties.fromJson(Map<String, dynamic> json) => QuicktypePubspecProperties(
