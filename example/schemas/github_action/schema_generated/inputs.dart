...
import 'inputs_pattern_property1.dart';
import 'validation_error.dart';

/// Input parameters allow you to specify data that the action expects to use during runtime. GitHub stores input parameters as environment variables. Input ids with uppercase letters are converted to lowercase during runtime. We recommended using lowercase input ids.
class Inputs {
  final Map<String, InputsPatternProperty1>? patternProperties;

  const Inputs({this.patternProperties});

  factory Inputs.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, InputsPatternProperty1>? patternPropertiesValue;
    {
      final patternPropertiesMap = <String, InputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] = InputsPatternProperty1.fromJson(
    ...
    return Inputs(patternProperties: patternPropertiesValue);
  }
