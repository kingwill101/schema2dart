...
import 'outputs_composite_pattern_property1.dart';
...
class OutputsComposite {
  ...
  factory OutputsComposite.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, OutputsCompositePatternProperty1>? patternPropertiesValue;
    {
      final patternPropertiesMap = <String, OutputsCompositePatternProperty1>{};
