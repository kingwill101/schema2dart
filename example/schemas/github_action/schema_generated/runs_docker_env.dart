...
class RunsDockerEnvObject extends RunsDockerEnv {
  final Map<String, RunsDockerEnvObjectAdditionalProperty>?
  additionalProperties;

  const RunsDockerEnvObject({this.additionalProperties}) : super();

  factory RunsDockerEnvObject.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, RunsDockerEnvObjectAdditionalProperty>?
    additionalPropertiesValue;
    if (unmatched.isNotEmpty) {
      final additionalPropertiesMap =
          <String, RunsDockerEnvObjectAdditionalProperty>{};
      for (final entry in unmatched.entries) {
        final value = entry.value;
        additionalPropertiesMap[entry.key] =
            RunsDockerEnvObjectAdditionalProperty.fromJson(
    ...
    return RunsDockerEnvObject(additionalProperties: additionalPropertiesValue);
  }
      ...
      _additionalPropertiesMap.forEach((key, value) {
        ...
        if (_constraintadditionalPropertiescount0 != 1) {
          throwValidationError(
            itemPointer,
            'oneOf',
            'Expected exactly one subschema in #/definitions/runs-docker/properties/env/oneOf/0/additionalProperties/oneOf to validate.',
          );
        }
        if (context != null &&
            _constraintadditionalPropertiesm0_0 &&
