...
class GithubWorkflowOnObjectWorkflowDispatchInputs {
  final Map<String, WorkflowDispatchInput>? patternProperties;

  const GithubWorkflowOnObjectWorkflowDispatchInputs({
    this.patternProperties,
  });

  factory GithubWorkflowOnObjectWorkflowDispatchInputs.fromJson(Map<String, dynamic> json) {
    ...
    return GithubWorkflowOnObjectWorkflowDispatchInputs(
