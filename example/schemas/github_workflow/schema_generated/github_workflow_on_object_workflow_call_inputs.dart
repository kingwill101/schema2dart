...
import 'github_workflow_on_object_workflow_call_inputs_pattern_property1.dart';
...
class GithubWorkflowOnObjectWorkflowCallInputs {
  final Map<String, GithubWorkflowOnObjectWorkflowCallInputsPatternProperty1>? patternProperties;

  const GithubWorkflowOnObjectWorkflowCallInputs({
    this.patternProperties,
  });

  factory GithubWorkflowOnObjectWorkflowCallInputs.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, GithubWorkflowOnObjectWorkflowCallInputsPatternProperty1>? patternPropertiesValue;
    {
      final patternPropertiesMap = <String, GithubWorkflowOnObjectWorkflowCallInputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] = GithubWorkflowOnObjectWorkflowCallInputsPatternProperty1.fromJson((value as Map).cast<String, dynamic>());
          matched = true;
        }
        if (!matched) {
    ...
    return GithubWorkflowOnObjectWorkflowCallInputs(
