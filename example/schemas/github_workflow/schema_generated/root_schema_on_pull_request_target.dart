...
class RootSchemaOnPullRequestTarget {
  ...
  const RootSchemaOnPullRequestTarget({
    this.branches,
    this.branchesIgnore,
    this.paths,
    this.pathsIgnore,
  ...
  factory RootSchemaOnPullRequestTarget.fromJson(Map<String, dynamic> json) {
    ...
    return RootSchemaOnPullRequestTarget(
      branches: branches,
