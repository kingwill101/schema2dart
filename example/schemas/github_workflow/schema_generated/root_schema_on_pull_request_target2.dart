...
class RootSchemaOnPullRequestTarget2 {
  ...
  const RootSchemaOnPullRequestTarget2({
    this.branches,
    this.branchesIgnore,
    this.paths,
    this.pathsIgnore,
  ...
  factory RootSchemaOnPullRequestTarget2.fromJson(Map<String, dynamic> json) {
    ...
    return RootSchemaOnPullRequestTarget2(
      branches: branches,
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    context?.annotate(
      ...
      schemaPointer:
          '#/properties/on/oneOf/2/properties/pull_request_target/oneOf/1/allOf/0/properties/types',
    );
    if (_value6 != null) {
