...
import 'on_schedule_item.dart';
import 'on_workflow_call.dart';
import 'on_workflow_dispatch.dart';
...
class On {
  ...
  final List<OnScheduleItem>? schedule;
  ...
  final OnWorkflowCall? workflowCall;
  ...
  final OnWorkflowDispatch? workflowDispatch;
  ...
  factory On.fromJson(Map<String, dynamic> json) {
    ...
    final schedule = json['schedule'] == null ? null : (json['schedule'] as List).map((e) => OnScheduleItem.fromJson((e as Map).cast<String, dynamic>())).toList();
    remaining.remove('schedule');
    final status = json['status'];
    remaining.remove('status');
    final watch = json['watch'];
    remaining.remove('watch');
    final workflowCall = json['workflow_call'] == null ? null : OnWorkflowCall.fromJson((json['workflow_call'] as Map).cast<String, dynamic>());
    remaining.remove('workflow_call');
    final workflowDispatch = json['workflow_dispatch'] == null ? null : OnWorkflowDispatch.fromJson((json['workflow_dispatch'] as Map).cast<String, dynamic>());
