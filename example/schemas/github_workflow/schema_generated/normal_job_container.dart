...
sealed class NormalJobContainer {
  ...
  factory NormalJobContainer.fromJson(dynamic json) {
    ...
    if (keys.contains('image')) {
      requiredMatches.add(NormalJobContainerObject.fromJson);
      requiredMatchNames.add('NormalJobContainerObject');
    }
    ...
    return NormalJobContainerObject.fromJson(json);
  }
...
class NormalJobContainerObject extends NormalJobContainer {
  ...
  const NormalJobContainerObject({
    this.credentials,
    this.env,
    required this.image,
    this.options,
  ...
  factory NormalJobContainerObject.fromJson(Map<String, dynamic> json) {
    ...
    return NormalJobContainerObject(
