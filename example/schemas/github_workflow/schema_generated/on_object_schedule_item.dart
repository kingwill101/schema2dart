...
class OnObjectScheduleItem {
  final String? cron;

  const OnObjectScheduleItem({this.cron});

  factory OnObjectScheduleItem.fromJson(Map<String, dynamic> json) {
    ...
    return OnObjectScheduleItem(cron: cron);
  }
