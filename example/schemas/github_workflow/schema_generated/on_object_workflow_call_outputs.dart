...
import 'on_object_workflow_call_outputs_pattern_property1.dart';
...
class OnObjectWorkflowCallOutputs {
  final Map<String, OnObjectWorkflowCallOutputsPatternProperty1>?
  patternProperties;

  const OnObjectWorkflowCallOutputs({this.patternProperties});

  factory OnObjectWorkflowCallOutputs.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, OnObjectWorkflowCallOutputsPatternProperty1>?
    patternPropertiesValue;
    {
      final patternPropertiesMap =
          <String, OnObjectWorkflowCallOutputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] =
              OnObjectWorkflowCallOutputsPatternProperty1.fromJson(
    ...
    return OnObjectWorkflowCallOutputs(
