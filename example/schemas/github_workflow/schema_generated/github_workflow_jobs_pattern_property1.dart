...
sealed class GithubWorkflowJobsPatternProperty1 {
  ...
  factory GithubWorkflowJobsPatternProperty1.fromJson(Map<String, dynamic> json) {
    ...
    if (keys.contains('runs-on')) {
      requiredMatches.add(GithubWorkflowJobsPatternProperty1Object.fromJson);
      requiredMatchNames.add('GithubWorkflowJobsPatternProperty1Object');
    }
    if (keys.contains('uses')) {
      requiredMatches.add(GithubWorkflowJobsPatternProperty1Object2.fromJson);
      requiredMatchNames.add('GithubWorkflowJobsPatternProperty1Object2');
    }
...
class GithubWorkflowJobsPatternProperty1Object extends GithubWorkflowJobsPatternProperty1 {
  ...
  const GithubWorkflowJobsPatternProperty1Object({
    this.concurrency,
    this.container,
  ...
  factory GithubWorkflowJobsPatternProperty1Object.fromJson(Map<String, dynamic> json) {
    ...
    return GithubWorkflowJobsPatternProperty1Object(
...
/// Each job must have an id to associate with the job. The key job_id is a string and its value is a map of the job's configuration data. You must replace <job_id> with a string that is unique to the jobs object. The <job_id> must start with a letter or _ and contain only alphanumeric characters, -, or _.
class GithubWorkflowJobsPatternProperty1Object2 extends GithubWorkflowJobsPatternProperty1 {
  /// Concurrency ensures that only a single job or workflow using the same concurrency group will run at a time. A concurrency group can be any string or expression. The expression can use any context except for the secrets context.
  /// You can also specify concurrency at the workflow level.
  /// When a concurrent job or workflow is queued, if another job or workflow using the same concurrency group in the repository is in progress, the queued job or workflow will be pending. Any previously pending job or workflow in the concurrency group will be canceled. To also cancel any currently running job or workflow in the same concurrency group, specify cancel-in-progress: true.
  ...
  final ContainerEnv? with_;

  const GithubWorkflowJobsPatternProperty1Object2({
    this.concurrency,
    this.if_,
    this.name,
    this.needs,
  ...
  factory GithubWorkflowJobsPatternProperty1Object2.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    ...
    final with_ = json['with'] == null ? null : ContainerEnv.fromJson((json['with'] as Map).cast<String, dynamic>());
    ...
    return GithubWorkflowJobsPatternProperty1Object2(
      concurrency: concurrency,
      if_: if_,
      name: name,
      needs: needs,
