...
sealed class Configuration {
  ...
  factory Configuration.fromJson(dynamic json) {
    ...
    if (json is List)
      return ConfigurationArray((json as List).map((e) => e).toList());
...
class ConfigurationObject extends Configuration {
  ...
  const ConfigurationObject({this.additionalProperties}) : super();
  ...
  factory ConfigurationObject.fromJson(Map<String, dynamic> json) {
    ...
    return ConfigurationObject(additionalProperties: additionalPropertiesValue);
  }
