...
class PermissionsObject extends Permissions {
  ...
  final PermissionsLevel? checks;
  final PermissionsLevel? contents;
  final PermissionsLevel? deployments;
  final PermissionsLevel? discussions;
  final PermissionsLevel? idToken;
  final PermissionsLevel? issues;
  final PermissionsObjectModels? models;
  final PermissionsLevel? packages;
  final PermissionsLevel? pages;
  final PermissionsLevel? pullRequests;
  final PermissionsLevel? repositoryProjects;
  final PermissionsLevel? securityEvents;
  final PermissionsLevel? statuses;
