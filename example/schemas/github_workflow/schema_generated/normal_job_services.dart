...
class NormalJobServices {
  ...
  const NormalJobServices({this.additionalProperties});
  ...
  factory NormalJobServices.fromJson(Map<String, dynamic> json) {
    ...
    if (unmatched.isNotEmpty) {
      ...
      for (final entry in unmatched.entries) {
        ...
        additionalPropertiesMap[entry.key] = Container.fromJson(
    ...
    return NormalJobServices(additionalProperties: additionalPropertiesValue);
  }
