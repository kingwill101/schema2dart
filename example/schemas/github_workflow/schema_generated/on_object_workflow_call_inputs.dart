...
import 'on_object_workflow_call_inputs_pattern_property1.dart';
...
class OnObjectWorkflowCallInputs {
  final Map<String, OnObjectWorkflowCallInputsPatternProperty1>?
  patternProperties;

  const OnObjectWorkflowCallInputs({this.patternProperties});

  factory OnObjectWorkflowCallInputs.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, OnObjectWorkflowCallInputsPatternProperty1>?
    patternPropertiesValue;
    {
      final patternPropertiesMap =
          <String, OnObjectWorkflowCallInputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] =
              OnObjectWorkflowCallInputsPatternProperty1.fromJson(
    ...
    return OnObjectWorkflowCallInputs(
