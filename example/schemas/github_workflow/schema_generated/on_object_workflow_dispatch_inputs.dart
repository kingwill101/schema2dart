...
class OnObjectWorkflowDispatchInputs {
  final Map<String, WorkflowDispatchInput>? patternProperties;

  const OnObjectWorkflowDispatchInputs({this.patternProperties});

  factory OnObjectWorkflowDispatchInputs.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, WorkflowDispatchInput>? patternPropertiesValue;
    {
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] = WorkflowDispatchInput.fromJson(
    ...
    return OnObjectWorkflowDispatchInputs(
