...
class GithubWorkflowOnObjectWorkflowCallOutputsPatternProperty1 {
  ...
  const GithubWorkflowOnObjectWorkflowCallOutputsPatternProperty1({
    this.description,
    required this.value,
  });

  factory GithubWorkflowOnObjectWorkflowCallOutputsPatternProperty1.fromJson(Map<String, dynamic> json) {
    ...
    return GithubWorkflowOnObjectWorkflowCallOutputsPatternProperty1(
