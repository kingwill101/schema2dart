...
import 'defaults_run_shell.dart';
...
class Step {
  ...
  factory Step.fromJson(Map<String, dynamic> json) {
    ...
    final continueOnError = (json['continue-on-error'] == null ? null : StepContinueOnError.fromJson((json['continue-on-error'] as Map).cast<String, dynamic>())) ?? false;
    ...
    final shell = json['shell'] == null ? null : DefaultsRunShell.fromJson((json['shell'] as Map).cast<String, dynamic>());
