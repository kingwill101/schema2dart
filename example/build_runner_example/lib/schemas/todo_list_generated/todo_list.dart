...
class TodoList {
  ...
  factory TodoList.fromJson(Map<String, dynamic> json) {
    ...
    final metadata = json['metadata'] == null
        ? null
        : Metadata.fromJson((json['metadata'] as Map).cast<String, dynamic>());
    ...
    return TodoList(items: items, metadata: metadata, name: name, tags: tags);
  }
  ...
  void validate({String pointer = '', ValidationContext? context}) {
    ...
    if (_value0.length > 25) {
      throwValidationError(
        _ptr0,
        'maxItems',
        'Expected at most 25 items but found ' +
            _value0.length.toString() +
            '.',
      );
    }
    ...
    if (_value3 != null) {
          ...
          try {
            ...
            if (!_patternp3c.hasMatch(item)) {
              throwValidationError(
                itemPointer,
                'pattern',
                'Expected value to match pattern ^urgent but found ' +
                    item +
                    '.',
              );
            }
      ...
      if (_containsCountp3 < 1) {
        throwValidationError(
          _ptr3,
          'contains',
          'Expected at least 1 item(s) matching "contains" but found ' +
              _containsCountp3.toString() +
              '.',
        );
      }
      if (_containsCountp3 > 5) {
        throwValidationError(
          _ptr3,
          'contains',
          'Expected at most 5 item(s) matching "contains" but found ' +
              _containsCountp3.toString() +
              '.',
        );
      }
