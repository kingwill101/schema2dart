...
QuicktypePubspec2 quicktypePubspec2FromJson(String str) => QuicktypePubspec2.fromJson(json.decode(str));

String quicktypePubspec2ToJson(QuicktypePubspec2 data) => json.encode(data.toJson());
...
class QuicktypePubspec2 {
    ...
    factory QuicktypePubspec2.fromJson(Map<String, dynamic> json) => QuicktypePubspec2(
